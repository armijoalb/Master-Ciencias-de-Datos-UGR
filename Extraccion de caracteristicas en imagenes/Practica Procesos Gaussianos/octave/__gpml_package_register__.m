...
## -*- texinfo -*-
## @deftypefn {} {} __gpml_package_register__ ()
## Undocumented internal function of gpml package.
## @end deftypefn

## PKG_ADD: __gpml_package_register__ (1);
## PKG_DEL: __gpml_package_register__ (-1);

function subdir_paths = __gpml_package_register__ (loading = 0)

  subdirlist = {"cov", "mean", "prior", "inf", "lik", "util", ...
                "help", "demo"};
