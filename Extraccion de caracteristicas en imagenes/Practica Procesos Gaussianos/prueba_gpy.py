...
def toy_linear_1d_classification(seed=default_seed, optimize=True, plot=True):
    ...
    ker = GPy.kern.RBF(1,variance=1,lengthscale=1.9)
    lik = GPy.likelihoods.Bernoulli()
    m = GPy.models.GPClassification(data['X'],Y,kernel=ker,likelihood=lik)
...
if __name__ == "__main__":    
    toy_linear_1d_classification(optimize=True, plot=True)