...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Leemos el fichero del dataset. La forma de escribir el PATH puede variar dependiendo de la organización o del SO.}
        \PY{n}{treasury} \PY{o}{=} \PY{n+nf}{read.csv}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{treasury//treasury.dat\PYZsq{}}\PY{p}{,} \PY{n}{comment.char} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{@\PYZsq{}}\PY{p}{,} \PY{n}{header} \PY{o}{=} \PY{k+kc}{FALSE}\PY{p}{,}
                           \PY{n}{stringsAsFactors} \PY{o}{=} \PY{k+kc}{FALSE}\PY{p}{)}
        ...
        \PY{n}{y\PYZus{}var} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{MonthCDRate\PYZsq{}}
        \PY{n}{pred\PYZus{}vars} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{CMaturityRate\PYZus{}1Y\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{CMortgageRate\PYZus{}30Y\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{Rate\PYZus{}AuctionAverage\PYZus{}3M\PYZsq{}}\PY{p}{,}
                      \PY{l+s}{\PYZsq{}}\PY{l+s}{Rate\PYZus{}SecondaryMarket\PYZus{}3M\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{CMaturityRate\PYZus{}3Y\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{CMaturityRate\PYZus{}5Y\PYZsq{}}\PY{p}{,}
                      \PY{l+s}{\PYZsq{}}\PY{l+s}{bankCredit\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{currency\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{demandDeposits\PYZsq{}}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{federalFunds\PYZsq{}}\PY{p}{,}
                      \PY{l+s}{\PYZsq{}}\PY{l+s}{moneyStock\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{checkableDeposits\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{loansLeases\PYZsq{}}\PY{p}{,}
                      \PY{l+s}{\PYZsq{}}\PY{l+s}{savingsDeposits\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{tradeCurrencies\PYZsq{}}\PY{p}{)}
        \PY{n+nf}{colnames}\PY{p}{(}\PY{n}{treasury}\PY{p}{)} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{pred\PYZus{}vars}\PY{p}{,}\PY{n}{y\PYZus{}var}\PY{p}{)}
        \PY{n+nf}{str}\PY{p}{(}\PY{n}{treasury}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} Utilizaremos la función summary para ver la media de las variables.}
        \PY{n+nf}{summary}\PY{p}{(}\PY{n}{treasury}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} Calculamos la media y la desviación estándar de las variables.}
        \PY{n}{media} \PY{o}{=} \PY{n+nf}{sapply}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n}{mean}\PY{p}{)}
        \PY{n}{desviacion} \PY{o}{=} \PY{n+nf}{sapply}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n}{sd}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Mostramos los valores.}
        \PY{n}{med\PYZus{}desv} \PY{o}{=} \PY{n+nf}{cbind}\PY{p}{(}\PY{n}{media}\PY{p}{,}\PY{n}{desviacion}\PY{p}{)}
        \PY{n}{med\PYZus{}desv}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} Ahora pasaremos a pintar las distribuciones de cada una de las variables, para ello, utilizaremos una }
        ...
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{Rate\PYZus{}AuctionAverage\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{Rate\PYZus{}AuctionAverage\PYZus{}3M}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{Rate\PYZus{}AuctionAverage\PYZus{}3M}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{)}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{bankCredit}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{bankCredit}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{bankCredit}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{currency}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{currency}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{currency}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{demandDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{demandDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{demandDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,}
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{federalFunds}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{federalFunds}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{federalFunds}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{checkableDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{checkableDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{checkableDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{loansLeases}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{loansLeases}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{loansLeases}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{savingsDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{savingsDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{savingsDeposits}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
                \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Pintamos los boxplots. En rojo se muestran ( si es que hay) los outliers.}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{Rate\PYZus{}AuctionAverage\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{bankCredit}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{currency}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{demandDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{federalFunds}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{checkableDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{loansLeases}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{savingsDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}boxplot}\PY{p}{(}\PY{n}{outlier.color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} Dibujamos las correlaciones entre las variables.}
        \PY{n+nf}{pairs}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{,} \PY{n}{main}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Correlaciones de los datos\PYZdq{}}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n+nf}{cor}\PY{p}{(}\PY{n}{treasury}\PY{p}{)}
\end{Verbatim}
...
un modelo lineal con dichas variables.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{Rate\PYZus{}AuctionAverage\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{bankCredit}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{currency}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{demandDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{federalFunds}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{checkableDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{loansLeases}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{savingsDeposits}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Copiamos una variable del dataset para ver como le afectaría las transformaciones.}
        \PY{n}{temp} \PY{o}{=} \PY{n}{treasury}\PY{o}{\PYZdl{}}\PY{n}{moneyStock}
        
        \PY{n}{log.temp} \PY{o}{=} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{log.data}\PY{o}{=}\PY{n+nf}{log}\PY{p}{(}\PY{n}{temp}\PY{p}{)}\PY{p}{)}
        \PY{n}{log.temp}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate} \PY{o}{=} \PY{n}{treasury}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{log.temp}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{log.data}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}density}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{..count..}\PY{p}{)}\PY{p}{,}\PY{n}{fill}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lightblue\PYZsq{}}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{mean}\PY{p}{(}\PY{n}{log.data}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{mean\PYZdq{}}\PY{p}{)}\PY{p}{,} 
                     \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6}\PY{p}{)} \PY{o}{+}
                \PY{n+nf}{geom\PYZus{}vline}\PY{p}{(}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{xintercept} \PY{o}{=} \PY{n+nf}{median}\PY{p}{(}\PY{n}{log.data}\PY{p}{)}\PY{p}{,}
                               \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{median\PYZdq{}}\PY{p}{)}\PY{p}{,}
                          \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{0.6} \PY{p}{)} \PY{o}{+}
                \PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{name} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{statistics\PYZdq{}}\PY{p}{,} 
                        \PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{n}{mean} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}FC4E07\PYZdq{}}\PY{p}{,} \PY{n}{median} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{blue\PYZdq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{log.temp}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{,}\PY{n}{x}\PY{o}{=}\PY{n}{log.data}\PY{p}{)}\PY{p}{)} \PY{o}{+}
            \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
        
        \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{cor}\PY{p}{(}\PY{n}{log.temp}\PY{p}{)}\PY{p}{)}
        \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{cor}\PY{p}{(}\PY{n}{treasury}\PY{o}{\PYZdl{}}\PY{n}{moneyStock}\PY{p}{,} \PY{n}{treasury}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo.}
         \PY{n}{fit1} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{treasury}\PY{p}{)}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit1}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Dibujamos el ajuste.}
         \PY{n+nf}{confint}\PY{p}{(}\PY{n}{fit1}\PY{p}{)}
         \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
             \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo.}
         \PY{n}{fit2} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{treasury}\PY{p}{)}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit2}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Dibujamos el ajuste.}
         \PY{n+nf}{confint}\PY{p}{(}\PY{n}{fit2}\PY{p}{)}
         \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
             \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo.}
         \PY{n}{fit3} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{treasury}\PY{p}{)}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit3}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Dibujamos el ajuste.}
         \PY{n+nf}{confint}\PY{p}{(}\PY{n}{fit3}\PY{p}{)}
         \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
             \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo.}
         \PY{n}{fit4} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{treasury}\PY{p}{)}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit4}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Dibujamos el ajuste.}
         \PY{n+nf}{confint}\PY{p}{(}\PY{n}{fit4}\PY{p}{)}
         \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{CMaturityRate\PYZus{}5Y}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
             \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo.}
         \PY{n}{fit5} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{moneyStock}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{treasury}\PY{p}{)}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit5}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Dibujamos el ajuste.}
         \PY{n+nf}{confint}\PY{p}{(}\PY{n}{fit5}\PY{p}{)}
         \PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{moneyStock}\PY{p}{,}\PY{n}{y}\PY{o}{=}\PY{n}{MonthCDRate}\PY{p}{)}\PY{p}{)} \PY{o}{+} 
             \PY{n+nf}{geom\PYZus{}point}\PY{p}{(}\PY{n}{col}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{deepskyblue\PYZdq{}}\PY{p}{)} \PY{o}{+} \PY{n+nf}{geom\PYZus{}smooth}\PY{p}{(}\PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{lm\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
hay sobreajuste y la calidad de nuestro mejor modelo obtenido.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}lm\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tra.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tst.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{p}{\PYZcb{}}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{lm}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{X11}\PY{p}{,}\PY{n}{x\PYZus{}tra}\PY{p}{)}
             \PY{n}{yprime}\PY{o}{=}\PY{n+nf}{predict}\PY{p}{(}\PY{n}{fitMulti}\PY{p}{,}\PY{n}{test}\PY{p}{)}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{lmMSEtrain.simple}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{lmMSEtest.simple}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{train: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtrain.simple}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{test: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtest.simple}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple1} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{.,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple1}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple2} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                            \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{bankCredit}\PY{o}{+}\PY{n}{currency}\PY{o}{+}\PY{n}{demandDeposits}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{checkableDeposits}\PY{o}{+}\PY{n}{loansLeases}\PY{o}{+}\PY{n}{savingsDeposits}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple2}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple3} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                            \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple3}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple4} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{CMaturityRate\PYZus{}5Y}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{Rate\PYZus{}SecondaryMarket\PYZus{}3M}\PY{p}{,}
                            \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple4}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple5} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{CMaturityRate\PYZus{}5Y}\PY{o}{+}\PY{n}{moneyStock}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple5}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple6} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                            \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{tradeCurrencies}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple6}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple7} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}
                            \PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{*}\PY{n}{currency}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple7}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple8} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}
                            \PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{*}\PY{n}{moneyStock}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple8}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple9} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                            \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{*}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple9}\PY{p}{)}
         
         
         \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple10} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{moneyStock}\PY{o}{*}\PY{n}{tradeCurrencies}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple10}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple11} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{*}\PY{o}{*}\PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple11}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple12} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{*}\PY{o}{*}\PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple12}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple13} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{*}\PY{o}{*}\PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple13}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple14} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{currency}\PY{o}{*}\PY{o}{*}\PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple14}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} Creamos el modelo}
         \PY{n}{fit.multiple15} \PY{o}{=} \PY{n+nf}{lm}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                             \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{currency}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}\PY{n}{tradeCurrencies}\PY{o}{+}
                            \PY{n+nf}{I}\PY{p}{(}\PY{n}{moneyStock}\PY{o}{*}\PY{o}{*}\PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{treasury}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Comprobamos los resultados}
         \PY{n+nf}{summary}\PY{p}{(}\PY{n}{fit.multiple15}\PY{p}{)}
\end{Verbatim}
...
modelos.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         ...
         \PY{n}{run\PYZus{}lm\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             ...
             \PY{n}{else} \PY{p}{\PYZob{}}
                 \PY{n}{test} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{x\PYZus{}tst}
             \PY{p}{\PYZcb{}}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{lm}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{X1}\PY{o}{+}\PY{n}{X2}\PY{o}{+}\PY{n}{X5}\PY{o}{+}\PY{n}{X7}\PY{o}{+}\PY{n}{X8}\PY{o}{+}\PY{n}{X9}\PY{o}{+}\PY{n}{X11}\PY{o}{+}\PY{n}{X12}\PY{o}{+}\PY{n}{X13}\PY{o}{+}\PY{n}{X14}\PY{o}{+}\PY{n}{X15}\PY{p}{,}\PY{n}{x\PYZus{}tra}\PY{p}{)}
             \PY{n}{yprime}\PY{o}{=}\PY{n+nf}{predict}\PY{p}{(}\PY{n}{fitMulti}\PY{p}{,}\PY{n}{test}\PY{p}{)}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{lmMSEtrain.multiple1}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{lmMSEtest.multiple1}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{train: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtrain.multiple1}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{test: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtest.multiple1}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
test:  0.05881755 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}lm\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tra.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             \PY{n}{x\PYZus{}tra} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{read.csv}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{n}{comment.char}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{@\PYZdq{}}\PY{p}{,} \PY{n}{header}\PY{o}{=}\PY{k+kc}{FALSE}\PY{p}{)}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tst.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{n}{else} \PY{p}{\PYZob{}}
                 \PY{n}{test} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{x\PYZus{}tst}
             \PY{p}{\PYZcb{}}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{lm}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{X1}\PY{o}{+}\PY{n}{X2}\PY{o}{+}\PY{n}{X5}\PY{o}{+}\PY{n}{X8}\PY{o}{+}\PY{n}{X11}\PY{o}{+}\PY{n}{X15}\PY{p}{,}\PY{n}{x\PYZus{}tra}\PY{p}{)}
             \PY{n}{yprime}\PY{o}{=}\PY{n+nf}{predict}\PY{p}{(}\PY{n}{fitMulti}\PY{p}{,}\PY{n}{test}\PY{p}{)}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{lmMSEtrain.multiple2}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{lmMSEtest.multiple2}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{train: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtrain.multiple2}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{test: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtest.multiple2}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{} cargamos la librería para utilizar knn}
         ...
         \PY{n}{treasury.norm} \PY{o}{=} \PY{n+nf}{as.data.frame}\PY{p}{(}\PY{n+nf}{lapply}\PY{p}{(}\PY{n}{treasury}\PY{p}{,}
...
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn1} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{.,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn1}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn2} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                        \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{bankCredit}\PY{o}{+}\PY{n}{currency}\PY{o}{+}\PY{n}{demandDeposits}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{checkableDeposits}\PY{o}{+}\PY{n}{loansLeases}\PY{o}{+}\PY{n}{savingsDeposits}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn2}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn3} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                        \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{bankCredit}\PY{o}{+}\PY{n}{currency}\PY{o}{+}\PY{n}{demandDeposits}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{checkableDeposits}\PY{o}{+}\PY{n}{loansLeases}\PY{o}{+}\PY{n}{savingsDeposits}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{5}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn3}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn4} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{.,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{5}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn4}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}36}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn5} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                        \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{bankCredit}\PY{o}{+}\PY{n}{currency}\PY{o}{+}\PY{n}{demandDeposits}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{checkableDeposits}\PY{o}{+}\PY{n}{loansLeases}\PY{o}{+}\PY{n}{savingsDeposits}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{7}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn5}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}37}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn6} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{.,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{7}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn6}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn7} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{CMaturityRate\PYZus{}1Y}\PY{o}{+}
                        \PY{n}{CMortgageRate\PYZus{}30Y}\PY{o}{+}\PY{n}{CMaturityRate\PYZus{}3Y}\PY{o}{+}
                            \PY{n}{bankCredit}\PY{o}{+}\PY{n}{currency}\PY{o}{+}\PY{n}{demandDeposits}\PY{o}{+}\PY{n}{moneyStock}\PY{o}{+}
                            \PY{n}{checkableDeposits}\PY{o}{+}\PY{n}{loansLeases}\PY{o}{+}\PY{n}{savingsDeposits}\PY{o}{+}
                            \PY{n}{tradeCurrencies}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{9}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn7}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}39}]:} \PY{c+c1}{\PYZsh{} Creamos un modelo y calculamos su RMSE}
         \PY{n}{fitknn8} \PY{o}{=} \PY{n+nf}{kknn}\PY{p}{(}\PY{n}{MonthCDRate}\PY{o}{\PYZti{}}\PY{n}{.,} \PY{n}{treasury.norm}\PY{p}{,} \PY{n}{treasury.norm}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{9}\PY{p}{)}
         \PY{n}{yprime} \PY{o}{=} \PY{n}{fitknn8}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
         \PY{n+nf}{print}\PY{p}{(}\PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{treasury.norm}\PY{o}{\PYZdl{}}\PY{n}{MonthCDRate}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}RMSE}
\end{Verbatim}
...
modelo más simple.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}knn\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             ...
             \PY{n}{else} \PY{p}{\PYZob{}}
                 \PY{n}{test} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{x\PYZus{}tst}
             \PY{p}{\PYZcb{}}
             \PY{n}{x\PYZus{}tra} \PY{o}{=} \PY{n+nf}{lapply}\PY{p}{(}\PY{n}{x\PYZus{}tra}\PY{p}{,}\PY{n}{scale}\PY{p}{,} \PY{n}{center} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{,} \PY{n}{scale} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
             \PY{n}{test} \PY{o}{=} \PY{n+nf}{lapply}\PY{p}{(}\PY{n}{test}\PY{p}{,}\PY{n}{scale}\PY{p}{,} \PY{n}{center} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{,} \PY{n}{scale} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{kknn}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{.,x\PYZus{}tra}\PY{p}{,}\PY{n}{test}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{5}\PY{p}{)}
             \PY{n}{yprime}\PY{o}{=}\PY{n}{fitMulti}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{knnMSEtrain.all}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}knn\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{knnMSEtest.all}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}knn\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
...
[1] 0.007427103
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}knn\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tra.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             \PY{n}{x\PYZus{}tra} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{read.csv}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{n}{comment.char}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{@\PYZdq{}}\PY{p}{,} \PY{n}{header}\PY{o}{=}\PY{k+kc}{FALSE}\PY{p}{)}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tst.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{n}{x\PYZus{}tra} \PY{o}{=} \PY{n+nf}{lapply}\PY{p}{(}\PY{n}{x\PYZus{}tra}\PY{p}{,}\PY{n}{scale}\PY{p}{,} \PY{n}{center} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{,} \PY{n}{scale} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
             \PY{n}{test} \PY{o}{=} \PY{n+nf}{lapply}\PY{p}{(}\PY{n}{test}\PY{p}{,}\PY{n}{scale}\PY{p}{,} \PY{n}{center} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{,} \PY{n}{scale} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{kknn}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{X1}\PY{o}{+}\PY{n}{X2}\PY{o}{+}\PY{n}{X5}\PY{o}{+}\PY{n}{X7}\PY{o}{+}\PY{n}{X8}\PY{o}{+}\PY{n}{X9}\PY{o}{+}\PY{n}{X11}\PY{o}{+}\PY{n}{X12}\PY{o}{+}\PY{n}{X13}\PY{o}{+}\PY{n}{X14}\PY{o}{+}\PY{n}{X15} \PY{p}{,}\PY{n}{x\PYZus{}tra}\PY{p}{,}\PY{n}{test}\PY{p}{,}\PY{n}{k}\PY{o}{=}\PY{l+m}{5}\PY{p}{)}
             
             \PY{n}{yprime}\PY{o}{=}\PY{n}{fitMulti}\PY{o}{\PYZdl{}}\PY{n}{fitted.values}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{knnMSEtrain.simple}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}knn\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{knnMSEtest.simple}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}knn\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{print}\PY{p}{(}\PY{n}{knnMSEtrain.simple}\PY{p}{)}
         \PY{n+nf}{print}\PY{p}{(}\PY{n}{knnMSEtest.simple}\PY{p}{)}
\end{Verbatim}
...
los datos utilizados por los algoritmos.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}lm\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tra.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             \PY{n}{x\PYZus{}tra} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{read.csv}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{n}{comment.char}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{@\PYZdq{}}\PY{p}{,} \PY{n}{header}\PY{o}{=}\PY{k+kc}{FALSE}\PY{p}{)}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tst.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{n}{else} \PY{p}{\PYZob{}}
                 \PY{n}{test} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{x\PYZus{}tst}
             \PY{p}{\PYZcb{}}
             \PY{n}{fitMulti}\PY{o}{=}\PY{n+nf}{lm}\PY{p}{(}\PY{n}{Y}\PY{o}{\PYZti{}}\PY{n}{.,x\PYZus{}tra}\PY{p}{)}
             \PY{n}{yprime}\PY{o}{=}\PY{n+nf}{predict}\PY{p}{(}\PY{n}{fitMulti}\PY{p}{,}\PY{n}{test}\PY{p}{)}
             \PY{n+nf}{sum}\PY{p}{(}\PY{n+nf}{abs}\PY{p}{(}\PY{n}{test}\PY{o}{\PYZdl{}}\PY{n}{Y}\PY{o}{\PYZhy{}}\PY{n}{yprime}\PY{p}{)}\PY{n}{\PYZca{}2}\PY{p}{)}\PY{o}{/}\PY{n+nf}{length}\PY{p}{(}\PY{n}{yprime}\PY{p}{)} \PY{c+c1}{\PYZsh{}\PYZsh{}MSE}
         \PY{p}{\PYZcb{}}
         \PY{n}{lmMSEtrain.all}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{train\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{lmMSEtest.all}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{mean}\PY{p}{(}\PY{n+nf}{sapply}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{5}\PY{p}{,}\PY{n}{run\PYZus{}lm\PYZus{}fold}\PY{p}{,}\PY{n}{nombre}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{train: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtrain.all}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{test: \PYZdq{}}\PY{p}{,}\PY{n}{lmMSEtest.all}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
test:  0.0606244 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{n}{nombre} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{treasury//treasury\PYZdq{}}
         \PY{n}{run\PYZus{}knn\PYZus{}fold} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{tt} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{test\PYZdq{}}\PY{p}{)} \PY{p}{\PYZob{}}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tra.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
             \PY{n}{x\PYZus{}tra} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{read.csv}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{n}{comment.char}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{@\PYZdq{}}\PY{p}{,} \PY{n}{header}\PY{o}{=}\PY{k+kc}{FALSE}\PY{p}{)}
             \PY{n}{file} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{paste}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}5\PYZhy{}\PYZdq{}}\PY{p}{,} \PY{n}{i}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{tst.dat\PYZdq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}
...
[1] 0.04609969
    ...
    Leemos los resultados de las tablas \emph{regr\_test\_alumnos.csv} y
\emph{regr\_train\_alumnos.csv}. Allí reemplazaremos los resultados por
los que se han obtenido en este estudio.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} Leemos los resultados de train.}
         \PY{n}{resultados.train} \PY{o}{=} \PY{n+nf}{read.csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{regr\PYZus{}train\PYZus{}alumnos.csv\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{rownames}\PY{p}{(}\PY{n}{resultados.train}\PY{p}{)} \PY{o}{=} \PY{n}{resultados.train}\PY{o}{\PYZdl{}}\PY{n}{X}
         \PY{n}{resultados.train}\PY{o}{\PYZdl{}}\PY{n}{X} \PY{o}{=} \PY{k+kc}{NULL}
         \PY{n}{resultados.train}\PY{n}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{treasury\PYZdq{}}\PY{p}{,}\PY{n}{]}\PY{o}{\PYZdl{}}\PY{n}{out\PYZus{}train\PYZus{}lm} \PY{o}{=} \PY{n}{lmMSEtrain.all}
         \PY{n}{resultados.train}\PY{n}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{treasury\PYZdq{}}\PY{p}{,}\PY{n}{]}\PY{o}{\PYZdl{}}\PY{n}{out\PYZus{}train\PYZus{}kknn} \PY{o}{=} \PY{n}{knnMSEtrain.all}
         
         \PY{n}{resultados.train}
         
         \PY{c+c1}{\PYZsh{} Hacemos lo mismo para test.}
         \PY{n}{resultados.test} \PY{o}{=} \PY{n+nf}{read.csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{regr\PYZus{}test\PYZus{}alumnos.csv\PYZdq{}}\PY{p}{)}
         \PY{n+nf}{rownames}\PY{p}{(}\PY{n}{resultados.test}\PY{p}{)} \PY{o}{=} \PY{n}{resultados.test}\PY{o}{\PYZdl{}}\PY{n}{X}
         \PY{n}{resultados.test}\PY{o}{\PYZdl{}}\PY{n}{X} \PY{o}{=} \PY{k+kc}{NULL}
         \PY{n}{resultados.test}\PY{n}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{treasury\PYZdq{}}\PY{p}{,}\PY{n}{]}\PY{o}{\PYZdl{}}\PY{n}{out\PYZus{}test\PYZus{}lm} \PY{o}{=} \PY{n}{lmMSEtest.all}
         \PY{n}{resultados.test}\PY{n}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{treasury\PYZdq{}}\PY{p}{,}\PY{n}{]}\PY{o}{\PYZdl{}}\PY{n}{out\PYZus{}test\PYZus{}kknn} \PY{o}{=} \PY{n}{knnMSEtest.all}
         
         \PY{n}{resultados.test}
\end{Verbatim}
...
\end{tabular}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{c+c1}{\PYZsh{} Preparamos los datos para realizar el test de Wilcoxon.}
         \PY{c+c1}{\PYZsh{} Utilizaremos el modelo de KNN como referencia.}
         \PY{n}{tablatst} \PY{o}{=} \PY{n}{resultados.test}
         \PY{n}{difs} \PY{o}{=} \PY{p}{(}\PY{n}{tablatst}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}\PY{o}{\PYZhy{}}\PY{n}{tablatst}\PY{n}{[}\PY{p}{,}\PY{l+m}{2}\PY{n}{]}\PY{p}{)}\PY{o}{/}\PY{n}{tablatst}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}
         \PY{n}{wilc\PYZus{}1\PYZus{}2} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{cbind}\PY{p}{(}\PY{n+nf}{ifelse }\PY{p}{(}\PY{n}{difs}\PY{o}{\PYZlt{}}\PY{l+m}{0}\PY{p}{,} \PY{n+nf}{abs}\PY{p}{(}\PY{n}{difs}\PY{p}{)}\PY{l+m}{+0.1}\PY{p}{,} \PY{l+m}{0}\PY{l+m}{+0.1}\PY{p}{)}\PY{p}{,}
                           \PY{n+nf}{ifelse }\PY{p}{(}\PY{n}{difs}\PY{o}{\PYZgt{}}\PY{l+m}{0}\PY{p}{,} \PY{n+nf}{abs}\PY{p}{(}\PY{n}{difs}\PY{p}{)}\PY{l+m}{+0.1}\PY{p}{,} \PY{l+m}{0}\PY{l+m}{+0.1}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{colnames}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{p}{)} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{c}\PY{p}{(}\PY{n+nf}{colnames}\PY{p}{(}\PY{n}{tablatst}\PY{p}{)}\PY{n}{[1}\PY{n}{]}\PY{p}{,} \PY{n+nf}{colnames}\PY{p}{(}\PY{n}{tablatst}\PY{p}{)}\PY{n}{[2}\PY{n}{]}\PY{p}{)}
         \PY{n+nf}{head}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Aplicamos el test e interpretamos los datos.}
         \PY{n}{LMvsKNNtst} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{wilcox.test}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}\PY{p}{,} \PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{n}{[}\PY{p}{,}\PY{l+m}{2}\PY{n}{]}\PY{p}{,}
                                   \PY{n}{alternative} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{two.sided\PYZdq{}}\PY{p}{,} \PY{n}{paired}\PY{o}{=}\PY{k+kc}{TRUE}\PY{p}{)}
         \PY{n}{Rmas} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{LMvsKNNtst}\PY{o}{\PYZdl{}}\PY{n}{statistic}
         \PY{n}{pvalue} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{LMvsKNNtst}\PY{o}{\PYZdl{}}\PY{n}{p.value}
         \PY{n}{LMvsKNNtst} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{wilcox.test}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{n}{[}\PY{p}{,}\PY{l+m}{2}\PY{n}{]}\PY{p}{,} \PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}\PY{p}{,}
                                   \PY{n}{alternative} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{two.sided\PYZdq{}}\PY{p}{,} \PY{n}{paired}\PY{o}{=}\PY{k+kc}{TRUE}\PY{p}{)}
         \PY{n}{Rmenos} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{LMvsKNNtst}\PY{o}{\PYZdl{}}\PY{n}{statistic}
         \PY{n}{Rmas}
         \PY{n}{Rmenos}
         \PY{n}{pvalue}
\end{Verbatim}
...
\end{tabular}
    ...
    Según los resultados obtenidos,no hay diferencias significativas entre
ambos algoritmos. Solamente tenemos un 23.4\% de confianza (1-0.76603)
que de los algoritmos sean distintos.

    \hypertarget{comparaciuxf3n-de-todos-los-algoritmos}{%
\subsubsection{Comparación de todos los
algoritmos}\label{comparaciuxf3n-de-todos-los-algoritmos}}

Ya hemos visto que no hay diferencias significativas entre los
algoritmos de regresión múltiple. Ahora, comprobaremos si existen
diferencias significativas entre alguno de los algoritmos, es decir,
tendremos también en cuenta los resultados proporcionados por el
algoritmo M5'.

Para compararlos utilizaremos el test de Friedman, y analizaremos sus
resultados. Después, independientemente de los resultados obtenidos por
el test de Friedman, realizaremos un test post-hoc de Holm para
comproabr si existe alguna diferencia entre los algoritmos.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{} Realizamos el test de Friedman.}
         \PY{n}{test\PYZus{}friedman} \PY{o}{=} \PY{n+nf}{friedman.test}\PY{p}{(}\PY{n+nf}{as.matrix}\PY{p}{(}\PY{n}{tablatst}\PY{p}{)}\PY{p}{)}
         \PY{n}{test\PYZus{}friedman}
\end{Verbatim}
...
Friedman chi-squared = 8.4444, df = 2, p-value = 0.01467
    ...
    Como podemos ver, el valor del p-valor del test de Friedman es muy
pequeño, por lo que podemos concluir que existen diferencias
significativas para al menos un par de algoritmos. Ahora realizaremos el
test de Holm para que algoritmo es el que se diferencia.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{} Aplicamos el test de Holm.}
         \PY{n}{tam} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{dim}\PY{p}{(}\PY{n}{tablatst}\PY{p}{)}
         \PY{n}{groups} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{n}{tam}\PY{n}{[2}\PY{n}{]}\PY{p}{,} \PY{n}{each}\PY{o}{=}\PY{n}{tam}\PY{n}{[1}\PY{n}{]}\PY{p}{)}
         \PY{n+nf}{pairwise.wilcox.test}\PY{p}{(}\PY{n+nf}{as.matrix}\PY{p}{(}\PY{n}{tablatst}\PY{p}{)}\PY{p}{,}
                              \PY{n}{groups}\PY{p}{,} \PY{n}{p.adjust} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{holm\PYZdq{}}\PY{p}{,}
                              \PY{n}{paired} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
\end{Verbatim}
...
P value adjustment method: holm 
    ...
    Como se puede ver en la tabla que nos devuelve este test, el algoritmo 3
(M5'), obtiene diferencias significativas con respecto a los algoritmos
1 (regresión lineal múltiple) y 2 (KNN). Los otros dos algoritmos
(regresión lineal múltiple y KNN) se pueden considerar iguales según la
información obtenida en el test (y la obtenida anteriormente en el test
de Wilcoxon).

    \hypertarget{comparaciones-para-los-datos-de-train}{%
\subsubsection{Comparaciones para los datos de
train}\label{comparaciones-para-los-datos-de-train}}

Por último, se aplicarán los mismo test pero a los datos obtenidos en
train, de esta forma podemos ver si existen diferencias entre los
resultados de test y los de train.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{\PYZsh{} creamos la tabla para train y aplicacamos el test de Wilcoxon}
         \PY{c+c1}{\PYZsh{} para los datos de regresión lineal múltiple y KNN.}
         \PY{n}{tablatrain} \PY{o}{=} \PY{n}{resultados.train}
         \PY{n}{difs} \PY{o}{=} \PY{p}{(}\PY{n}{tablatrain}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}\PY{o}{\PYZhy{}}\PY{n}{tablatrain}\PY{n}{[}\PY{p}{,}\PY{l+m}{2}\PY{n}{]}\PY{p}{)}\PY{o}{/}\PY{n}{tablatrain}\PY{n}{[}\PY{p}{,}\PY{l+m}{1}\PY{n}{]}
         \PY{n}{wilc\PYZus{}1\PYZus{}2} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{cbind}\PY{p}{(}\PY{n+nf}{ifelse }\PY{p}{(}\PY{n}{difs}\PY{o}{\PYZlt{}}\PY{l+m}{0}\PY{p}{,} \PY{n+nf}{abs}\PY{p}{(}\PY{n}{difs}\PY{p}{)}\PY{l+m}{+0.1}\PY{p}{,} \PY{l+m}{0}\PY{l+m}{+0.1}\PY{p}{)}\PY{p}{,}
                           \PY{n+nf}{ifelse }\PY{p}{(}\PY{n}{difs}\PY{o}{\PYZgt{}}\PY{l+m}{0}\PY{p}{,} \PY{n+nf}{abs}\PY{p}{(}\PY{n}{difs}\PY{p}{)}\PY{l+m}{+0.1}\PY{p}{,} \PY{l+m}{0}\PY{l+m}{+0.1}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{colnames}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{p}{)} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{c}\PY{p}{(}\PY{n+nf}{colnames}\PY{p}{(}\PY{n}{tablatrain}\PY{p}{)}\PY{n}{[1}\PY{n}{]}\PY{p}{,} \PY{n+nf}{colnames}\PY{p}{(}\PY{n}{tablatrain}\PY{p}{)}\PY{n}{[2}\PY{n}{]}\PY{p}{)}
         \PY{n+nf}{head}\PY{p}{(}\PY{n}{wilc\PYZus{}1\PYZus{}2}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{tabular}{ll}
 out\_train\_lm & out\_train\_kknn\\
\hline
	 0.1       & 0.6394191\\
	 0.1       & 1.0629412\\
	 0.1       & 0.7873339\\
...
\end{tabular}
    ...
    Como se puede ver podemos afirmar que para train, con un 99.96\% de
confianza (1-0.0003281), existen diferencias entre los algoritmos. Esto
es así porque el algoritmo KNN suele ajustarse mucho a los datos con los
que se entrena (train), pero no tanto a los datos de test (sobreajuste);
por ello, existen diferencias significativas en train pero no en test
(como se puede ver en el apartado anterior).

Ahora realizaremos el test de Friedman y post-hoc y analizaremos los
resultados.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{c+c1}{\PYZsh{} Realizamos el test de Friedman.}
         \PY{n}{test\PYZus{}friedman} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{friedman.test}\PY{p}{(}\PY{n+nf}{as.matrix}\PY{p}{(}\PY{n}{tablatrain}\PY{p}{)}\PY{p}{)}
         \PY{n}{test\PYZus{}friedman}
\end{Verbatim}
...
Friedman chi-squared = 20.333, df = 2, p-value = 3.843e-05
    ...
    Al igual que en el apartado anterior, el test de Friedman nos muestra
que existen diferencias entre los algoritmos que estamos comparando.
Realizamos el test de Holm y analizamos los resultados obtenidos.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{c+c1}{\PYZsh{} Realizamos el test de Holm.}
         \PY{n}{tam} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{dim}\PY{p}{(}\PY{n}{tablatrain}\PY{p}{)}
         \PY{n}{groups} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{n}{tam}\PY{n}{[2}\PY{n}{]}\PY{p}{,} \PY{n}{each}\PY{o}{=}\PY{n}{tam}\PY{n}{[1}\PY{n}{]}\PY{p}{)}
         \PY{n+nf}{pairwise.wilcox.test}\PY{p}{(}\PY{n+nf}{as.matrix}\PY{p}{(}\PY{n}{tablatrain}\PY{p}{)}\PY{p}{,}
                              \PY{n}{groups}\PY{p}{,} \PY{n}{p.adjust} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{holm\PYZdq{}}\PY{p}{,} 
                              \PY{n}{paired} \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
\end{Verbatim}
...
P value adjustment method: holm 
    ...
    Según los resultados obtenidos para este test, no existen diferencias
significativas entre los algoritmos que hemos comparado, a diferencia de
los resultados de test. Esto ocurre por el sobreajuste de los algoritmos
para los datos de train; dado que estamos comparando resultados
obtenidos para los datos con los que se entrenan los algoritmos, y por
lo tanto se ajustan mejor que para otros datos diferentes (test), es más
difícil encontrar diferencias significativas.
